# Assignment 1: Testing the MFA Server
...
For the JUnit test scripts, we will clone everyone's Gitlab repository at the due time. We will mark the latest version on the main  branch of the repository. 
...
If you submit late, email  to let him know so he can pull the changes from the repository.
